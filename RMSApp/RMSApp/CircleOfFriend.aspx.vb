...
Partial Public Class CircleOfFriends
    ...
    Public Sub AddMyFriends(ByVal strUserName As String)
        ...
        If objDR.HasRows Then
            ...
            While objDR.Read
                ...
                Me.AddAFriendControl(objDR("Friend Name").ToString & " (" & objDR("Email").ToString & ")", strImage, strPending, iCounter)
            End While
        Else
    ...
    Public Sub AddMyInvitations(ByVal strUserName As String)
        ...
        If objDR.HasRows Then
            ...
            While objDR.Read
                ...
                strImage = ReturnImageProfile(objDR("Email").ToString)
                Me.AddAnInviteControl(objDR("Friend Name").ToString & " (" & objDR("Email").ToString & ")", strImage, iCounter)

            End While
        Else
            Me.AddAnInviteControl("NOINVITE", "NOIMAGE", 1)
        End If
    ...
    Public Sub AddAFriendControl(ByVal strName As String,
        ...
        lblItemNo.ID = "lblItemNo_" & intCounter.ToString
        lblItemNo.Text = intCounter.ToString & "."

        ' Setup the Name Control
        lblName.ID = "lblFriendName_" & intCounter.ToString
        lblName.Text = strName

        ' Setup the Image
        imgFriend.ID = "imgFriend_" & intCounter.ToString
        imgFriend.Width = 50
        imgFriend.Height = 50
        ...
        lblStatus.ID = "lblStatus_" & intCounter.ToString
        lblStatus.Text = strStatus

        btnAction.ID = "btnAction_" & intCounter.ToString
    ...
    Public Sub AddAnInviteControl(ByVal strName As String,
        ...
        Else
            ...
            btnAccept.ID = "btnAccept_" & intCounter.ToString
            btnAccept.Text = "Accept"
            btnAccept.Attributes.Add("Class", "btn btn-primary btn-sm")

            btnReject.ID = "btnReject_" & intCounter.ToString

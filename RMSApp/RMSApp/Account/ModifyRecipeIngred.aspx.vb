...
Public Class ModifyRecipeIngred
    Inherits Page
    ...
    Private Sub FillInIngredInfo(ByVal strIngredID As String)
        ...
        If objDR.HasRows Then
            ...
            Me.ddUOM.SelectedIndex = ddUOM.Items.IndexOf(ddUOM.Items.FindByText(objDR("UOMType").ToString))
    ...
    Protected Sub SaveChanges_Click(sender As Object, e As EventArgs)
        ...
        objDR = objData_DB.RunStoredProc("usp_RecipeIngredient_Update_ByIngredID", objParams)

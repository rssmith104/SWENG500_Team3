<%@ Page Title="ManageMyRecipe" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ManageMyRecipe.aspx.vb" Inherits="RMSApp.ManageMyRecipe" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        <h4>Manage Recipe for Account:     <b><%=strLoggedInUser%></b> </h4>

...
Public Class RemoveRecipeStep
    ...
    Protected Sub RemoveStep_Click(sender As Object, e As EventArgs)
        Dim objData_DB As clsData_DB
        Dim strConnectionString As String
        Dim objParams(0) As SqlParameter
        Dim objDR As SqlDataReader
        ...
        objDR = objData_DB.RunStoredProc("usp_InstructionStep_Delete_ByStepID", objParams)

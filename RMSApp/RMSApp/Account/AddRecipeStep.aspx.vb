...
Public Class AddRecipeStep
    ...
    Protected Sub SaveChanges_Click(sender As Object, e As EventArgs)
        ...
        objParams(0) = objData_DB.MakeInParam("@RecipeID ", SqlDbType.Int, 4, CInt(Me.strRecipeID))
        objParams(1) = objData_DB.MakeInParam("@StepText", SqlDbType.VarChar, 200, Me.txtStepText.Text)

        objDR = objData_DB.RunStoredProc("usp_InstructionStep_Insert_AutoNumber", objParams)

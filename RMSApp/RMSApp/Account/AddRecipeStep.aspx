<%@ Page Title="AddRecipeStep" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddRecipeStep.aspx.vb" Inherits="RMSApp.AddRecipeStep" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        <h4>Add Recipe Step For:&nbsp;&nbsp;&nbsp;&nbsp;<b><%=strLoggedInUser %></b> </h4>

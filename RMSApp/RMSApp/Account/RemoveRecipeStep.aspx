<%@ Page Title="RemoveRecipeStep" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RemoveRecipeStep.aspx.vb" Inherits="RMSApp.RemoveRecipeStep" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Remove Recipe Step</h2>
    <p class="text-danger">
        <asp:Literal runat="server" ID="ErrorMessage" />
    </p>

    <div class="form-horizontal">
        <h4>Remove Recipe Step For:&nbsp;&nbsp;&nbsp;&nbsp;<b><%=strLoggedInUser %></b> </h4>
        ...
        <asp:Table ID="Table1" runat="server" Width="100%" GridLines="None" >
            ...
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                    <asp:Button ID="btnSubmit" runat="server" Text="Remove" OnClick="RemoveStep_Click" CssClass="btn btn-primary btn-md" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnCancel" runat="server" Text="Cancel" CausesValidation="false" CssClass="btn btn-primary btn-md"/>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </div>
